...
TemnyiVPN-Client is an open-source VPN client for Windows and Android, built with
...
TemnyiVPN is under active development. The Windows client currently supports
...
TemnyiVPN is licensed under the GNU General Public License v3.0. See
