#define MyAppName "TemnyiVPN"
#define MyAppExeName "entropy_vpn.exe"
#define MyAppPublisher "TemnyiVPN"
...
OutputBaseFilename=TemnyiVPN-Setup-{#MyAppVersion}
...
Filename: "{sys}\sc.exe"; Parameters: "create EntropyVPNService binPath= ""{app}\entropy_vpn_service.exe service"" start= demand DisplayName= ""TemnyiVPN Service"""; Flags: runhidden waituntilterminated
Filename: "{sys}\sc.exe"; Parameters: "description EntropyVPNService ""Provides privileged Windows TUN mode support for TemnyiVPN."""; Flags: runhidden waituntilterminated
