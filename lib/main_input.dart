...
class InputPanelState extends State<InputPanel> {
  static final Uri _buyVpnUri = Uri.parse('https://t.me/temnyi_vpn_bot');
  ...
  Future<void> _openBuyVpn() async {
    await launchUrl(_buyVpnUri, mode: LaunchMode.externalApplication);
  }
