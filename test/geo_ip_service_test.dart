...
void main() {
  ...
  test('Android runtime start path uses cached GeoIP without awaiting lookup', () async {
    ...
    expect(
      source,
      contains('serverCountryCode: _cachedAndroidServerCountryCode(profile)'),
    );
    expect(source, isNot(contains('serverCountryCode: await')));
  });
