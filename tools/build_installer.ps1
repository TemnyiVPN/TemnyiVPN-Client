...
#   - the installer filename (TemnyiVPN-Setup-$appVersion.exe)
...
if (-not $?) {
  throw 'build_release_manifest.ps1 failed'
}
...
$installerExe = Join-Path $outputDir "TemnyiVPN-Setup-$appVersion.exe"
