...
class FwpEngine {
 public:
  ...
  DWORD Open() {
    ...
    session.displayData.name = const_cast<wchar_t*>(L"TemnyiVPN Killswitch");
    session.displayData.description =
        const_cast<wchar_t*>(L"TemnyiVPN killswitch transient session");
...
DWORD EnsureProviderAndSublayer(HANDLE engine, std::string* error_step) {
  ...
  provider.displayData.name = const_cast<wchar_t*>(L"TemnyiVPN Killswitch");
  provider.displayData.description =
      const_cast<wchar_t*>(L"TemnyiVPN killswitch filter provider");
  ...
  sublayer.displayData.name = const_cast<wchar_t*>(L"TemnyiVPN Killswitch");
  sublayer.displayData.description =
      const_cast<wchar_t*>(L"TemnyiVPN killswitch filters");
...
DWORD AddFilter(HANDLE engine,
  ...
  filter.displayData.name = const_cast<wchar_t*>(L"TemnyiVPN Killswitch");
